...
print(var)
var_len = length(var)
print(paste("Variable color has length", var_len))

print("------------------------Running var_serialization for color-----------------------")
print(opt$color)
color = var_serialization(opt$color)
print("---------------------------------------------------------------------------------")
...
id <- gsub("\"", "", opt$id)
print("Retrieving param_annotation_off_x")
var = opt$param_annotation_off_x
print(var)
var_len = length(var)
print(paste("Variable param_annotation_off_x has length", var_len))
