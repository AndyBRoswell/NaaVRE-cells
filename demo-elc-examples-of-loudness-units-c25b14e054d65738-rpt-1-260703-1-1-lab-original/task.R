...
make_option(c("--max_dB"), action="store", default=NA, type="integer", help="my description"), 
make_option(c("--min_dB"), action="store", default=NA, type="integer", help="my description"), 
